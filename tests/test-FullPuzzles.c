...
int test_fullPuzzles ()
{
	...
	int iterations = 0, difference = 0, totalPermutations = 0, maxPermutations = 0;
	Timings timings = {0};
	...
	actualSolution = solvePuzzle(filePtr, MODE_TEST, &iterations, &totalPermutations, &maxPermutations, &timings);
	fclose(filePtr);
